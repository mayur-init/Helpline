...
function BloodBankRegister() {
  ...
  const [BloodBankProviderName, setBloodBankProviderName] = useState('');
  ...
  return (
    <div className='shadow-xl p-4 rounded-xl min-h-max'>
      <h1 className='text-gray-600 text-3xl font-bold my-[4vh] flex justify-center hover:text-violet-600'>Blood Bank Service</h1>
      <div className='flex flex-col w-[50vh] h-auto mt-[8vh] mb-[4vh]'>
        <input type='text' onChange={(e) => { setBloodBankProviderName(e.target.value) }} value={BloodBankProviderName} placeholder='Service Provider Name' className='border-2 border-gray-600 rounded-full px-4 py-1 my-2'></input>
