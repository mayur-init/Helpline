  ...
  return (
    <div className='min-h-screen flex flex-col justify-center items-center bg-white'>
      <div className='grid md:grid-cols-2 mx-0 md:mx-[35vh] mt-0 md:mt-[4vh]'>
        <img src='assets/img7.webp' className='w-[80vw] h-[70vw] md:w-[100vw] md:h-[80vh]'></img>
        <div className='flex justify-start text-start'>
          <div className='flex flex-col justify-start md:justify-center mx-4 mb-[12vh] md:mb-0 md:mt-[10vh]'>
