...
export default function RegisterDropdown() {
  ...
  return (
    <div>
      <button className='flex justify-center text-md text-semibold text-gray-600 underline hover:text-violet-600 hover:text-white' onClick={() => setActive(!isActive)}>Register<HiChevronDown className='mt-2 ml-1 text-sm'/></button>
